...
| Worker concurrency                               | **PARTIALLY COMPLETE, resolved by your answer**                      | Only an in-process boolean guard — safe _because_ you've confirmed the worker deploys as a single instance. No cross-instance lock exists; do not scale the worker horizontally without adding one.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
