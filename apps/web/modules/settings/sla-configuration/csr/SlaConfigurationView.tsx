...
export const SlaConfigurationView = ({ data }: SlaConfigurationViewProps) => {
  const { engineeringLegTargetMinutes, slaPolicies, businessCalendars, customerCalendars } = data;
    ...
    <div className="grid grid-cols-1 gap-4 lg:grid-cols-2 xl:grid-cols-3">
        ...
        <Card className="h-full overflow-hidden">
          ...
          <CardContent className="space-y-5 px-5 py-5">
            <p className={descriptionClass}>
              ...
              policy version — existing commitments keep the version they
              were created under, changes apply to new commitments only.
            </p>
      ...
      <Reveal delay={0.1}>
        <Card className="h-full overflow-hidden">
          ...
          <CardContent className="space-y-5 px-5 py-5">
            <p className={descriptionClass}>
              Override business hours for specific customers — pin a
              customer to one of the org&apos;s existing calendars instead of
              whatever their matched SLA policy would otherwise resolve to.
              Only new commitments pick up the change.
            </p>
