...
The OLA differentiator survives; the OLA _configuration surface_ disappears. This is the single largest scope reduction available and it costs nothing.
...
| **Escalation _actions_** (auto-reassign, auto-comment, write-back) | Write access changes the security conversation completely and turns a read-only install into a procurement review. **Stay read-only in v1** — this is worth more than any feature. |
